...
pub fn run_opcode(current_state: &mut CpuState, opcode: u8, cpu_mem: &mut CpuMemory, shared_mem: &Arc<GeneralMemory>) -> CycleResult {
...
fn rlc_hl(af: &mut CpuReg, hl: &mut CpuReg, cpu_mem: &mut CpuMemory, shared_mem: &Arc<GeneralMemory>) -> (u16, u16) {
...
fn rrc_hl(af: &mut CpuReg, hl: &mut CpuReg, cpu_mem: &mut CpuMemory, shared_mem: &Arc<GeneralMemory>) -> (u16, u16) {
...
fn rl_hl(af: &mut CpuReg, hl: &mut CpuReg, cpu_mem: &mut CpuMemory, shared_mem: &Arc<GeneralMemory>) -> (u16, u16) {
...
fn rr_hl(af: &mut CpuReg, hl: &mut CpuReg, cpu_mem: &mut CpuMemory, shared_mem: &Arc<GeneralMemory>) -> (u16, u16) {
...
fn sla_val(af: &mut CpuReg, hl: &mut CpuReg, cpu_mem: &mut CpuMemory, shared_mem: &Arc<GeneralMemory>) -> (u16, u16) {
...
fn sra_val(af: &mut CpuReg, hl: &mut CpuReg, cpu_mem: &mut CpuMemory, shared_mem: &Arc<GeneralMemory>) -> (u16, u16) {
...
fn swap_hl(af: &mut CpuReg, hl: &mut CpuReg, cpu_mem: &mut CpuMemory, shared_mem: &Arc<GeneralMemory>) -> (u16, u16) {
...
fn srl_val(af: &mut CpuReg, hl: &mut CpuReg, cpu_mem: &mut CpuMemory, shared_mem: &Arc<GeneralMemory>) -> (u16, u16) {
...
fn bit_hl(checked_bit: u8, af: &mut CpuReg, hl: &mut CpuReg, cpu_mem: &mut CpuMemory, shared_mem: &Arc<GeneralMemory>) -> (u16, u16) {
...
fn res_hl(bit: u8, hl: &mut CpuReg, cpu_mem: &mut CpuMemory, shared_mem: &Arc<GeneralMemory>) -> (u16, u16) {
...
fn set_hl(bit: u8, hl: &mut CpuReg, cpu_mem: &mut CpuMemory, shared_mem: &Arc<GeneralMemory>) -> (u16, u16) {
