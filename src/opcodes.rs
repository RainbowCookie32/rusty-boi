...
pub fn run_opcode(state: &mut CpuState, opcode: u8, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) -> CycleResult {
...
fn halt(current_state: &mut CpuState, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) -> CycleResult {
...
fn jump(state: &mut CpuState, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) {
...
fn relative_jump(state: &mut CpuState, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) {
...
fn conditional_jump(state: &mut CpuState, condition: JumpCondition, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) {
...
fn conditional_relative_jump(state: &mut CpuState, condition: JumpCondition, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) {
...
fn call(state: &mut CpuState, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) {
...
fn conditional_call(state: &mut CpuState, condition: JumpCondition, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) {
...
fn ret(state: &mut CpuState, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) {
    
    state.pc.set(cpu::stack_read(&mut state.sp, cpu_mem, shared_mem));
    state.cycles.add(16);
}

fn reti(state: &mut CpuState, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) {

    cpu::toggle_interrupts(state, true);
    ret(state, cpu_mem, shared_mem);
}

fn conditional_ret(state: &mut CpuState, condition: JumpCondition, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) {
...
fn add_imm_to_sp_save_in_hl(state: &mut CpuState, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) -> (u16, u16) {
...
fn load_imm_into_hi(register: &mut CpuReg, pc: u16, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) -> (u16, u16) {
...
fn load_imm_into_low(register: &mut CpuReg, pc: u16, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) -> (u16, u16) {
...
fn ld_imm_into_full(register: &mut CpuReg, pc: u16, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) -> (u16, u16) {
...
fn ld_a_from_imm_addr(af: &mut CpuReg, pc: u16, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) -> (u16, u16) {
...
fn ld_a_from_ff_imm(af: &mut CpuReg, pc: u16, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) -> (u16, u16) {
...
fn ld_a_from_ff_c(af: &mut CpuReg, bc: &mut CpuReg, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) -> (u16, u16) {
...
fn load_hl_into_hi(register: &mut CpuReg, hl: u16, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) -> (u16, u16) {
...
fn load_hl_into_low(register: &mut CpuReg, hl: u16, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) -> (u16, u16) {
...
fn load_hl_into_h(register: &mut CpuReg, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) -> (u16, u16) {
...
fn load_hl_into_l(register: &mut CpuReg, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) -> (u16, u16) {
...
fn load_bc_into_a(register: &mut CpuReg, bc: u16, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) -> (u16, u16) {
...
fn load_de_into_a(register: &mut CpuReg, de: u16, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) -> (u16, u16) {
...
fn ld_a_from_hl_inc(af: &mut CpuReg, hl: &mut CpuReg, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) -> (u16, u16) {
...
fn ld_a_from_hl_dec(af: &mut CpuReg, hl: &mut CpuReg, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) -> (u16, u16) {
...
fn save_a_to_hl_inc(register: &mut CpuReg, hl: &mut CpuReg, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) -> (u16, u16) {
...
fn save_a_to_hl_dec(a: &mut CpuReg, hl: &mut CpuReg, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) -> (u16, u16) {
...
fn save_value_to_hl(value: u8, hl: u16, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) -> (u16, u16) {

    memory::cpu_write(hl, value, cpu_mem, shared_mem);
    (1, 8)
}

fn save_hi_to_hl(hl: &mut CpuReg, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) -> (u16, u16) {

    memory::cpu_write(hl.get_register(), hl.get_register_lb(), cpu_mem, shared_mem);
    (1, 8)
}

fn save_low_to_hl(hl: &mut CpuReg, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) -> (u16, u16) {
...
fn save_a_to_full(register: &mut CpuReg, full: &mut CpuReg, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) -> (u16, u16) {
...
fn save_a_to_ff_imm(af: &mut CpuReg, pc: u16, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) -> (u16, u16) {
...
fn save_a_to_ff_c(af: &mut CpuReg, bc: &mut CpuReg, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) -> (u16, u16) {
...
fn save_a_to_nn(af: &mut CpuReg, pc: u16, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) -> (u16, u16) {
...
fn save_imm_to_hl(hl: &mut CpuReg, pc: u16, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) -> (u16, u16) {
...
fn save_sp_to_imm(sp: &mut CpuReg, pc: u16, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) -> (u16, u16) {
...
fn increment_value(af: &mut CpuReg, hl: &mut CpuReg, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) -> (u16, u16) {
...
fn decrement_at_hl(af: &mut CpuReg, hl: &mut CpuReg, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) -> (u16, u16) {
...
fn add_imm_to_sp(af: &mut CpuReg, sp: &mut CpuReg, pc: u16, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) -> (u16, u16) {
...
fn add_hl(register: &mut CpuReg, hl: u16, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) -> (u16, u16) {
...
fn adc_hl(register: &mut CpuReg, hl: u16, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) -> (u16, u16) {
...
fn sub_hl(register: &mut CpuReg, hl: u16, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) -> (u16, u16) {
...
fn sbc_hl(register: &mut CpuReg, hl: u16, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) -> (u16, u16) {
...
fn and_hl(register: &mut CpuReg, hl: u16, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) -> (u16, u16) {
...
fn or_hl(register: &mut CpuReg, hl: u16, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) -> (u16, u16) {
...
fn xor_hl(register: &mut CpuReg, hl: u16, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) -> (u16, u16) {
...
fn cp_hl(register: &mut CpuReg, hl: u16, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) -> (u16, u16) {
...
fn pop(reg: &mut CpuReg, sp: &mut CpuReg, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) -> (u16, u16) {
...
fn push(reg: &mut CpuReg, sp: &mut CpuReg, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) -> (u16, u16) {
...
fn rst(target: u16, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>), state: &mut CpuState) {
