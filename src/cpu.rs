...
pub fn start_cpu(cycles: Arc<Mutex<u16>>, memory: (CpuMemory, Arc<IoRegisters>, Arc<GpuMemory>), input: Receiver<InputEvent>) {
...
fn update_inputs(input_rx: &Receiver<InputEvent>, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) -> bool {
...
fn handle_interrupts(current_state: &mut CpuState, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) {
...
pub fn read_immediate(address: u16, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) -> u8 {

    memory::cpu_read(address + 1, cpu_mem, shared_mem)
}

pub fn read_u16(addr: u16, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) -> u16 {
...
pub fn stack_read(sp: &mut CpuReg, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) -> u16 {
...
pub fn stack_write(sp: &mut CpuReg, value: u16, cpu_mem: &mut CpuMemory, shared_mem: &(Arc<IoRegisters>, Arc<GpuMemory>)) {
